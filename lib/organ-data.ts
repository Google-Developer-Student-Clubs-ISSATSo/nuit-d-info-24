...
export const ORGANS: Organ[] = [
  {
    id: "heart",
    name: "Cœur",
    description: "Un organe musculaire qui pompe le sang à travers le système circulatoire",
    ...
    oceanMetaphor: {
      ...
      marineSimilarity: "Tel un cœur océanique, le système circulatoire marine redistribue l'énergie et les nutriments à travers les vastes étendues marines, comparable aux courants globaux qui nourrissent les écosystèmes océaniques.",
    },
    position: {
      x: 50,
      y: 30,
  ...
  },
  {
    id: "liver",
    name: "Foie",
    description: "Un organe vital responsable de la détoxification, de la synthèse protéique et des processus métaboliques",
    function: "Détoxifier le sang, produire des substances biochimiques et réguler le métabolisme",
    ...
    oceanMetaphor: {
      ...
      marineSimilarity: "Comme un foie océanique, les zones de convergence marine agissent comme un système de filtration naturel, absorbant et transformant les polluants, maintenant l'équilibre écologique des océans.",
    },
    position: {
      x: 38,
      y: 68,
  ...
  },
  {
    ...
    function: "Traiter l'information, contrôler les fonctions corporelles et générer des pensées",
    location: "Crâne",
    funFacts: [
    ...
    oceanMetaphor: {
      ...
      marineSimilarity: "Tel un cerveau océanique, les systèmes de communication sous-marins - comme les signaux acoustiques des baleines - créent un réseau complexe de communication et de navigation à travers les profondeurs.",
    },
    position: {
      x: 43,
      y: -1,
  ...
  },
  {
    id: "stomach",
    name: "Estomac",
    description: "Un organe musculaire qui décompose les aliments et commence la digestion",
    ...
    oceanMetaphor: {
      ...
      marineSimilarity: "Comme un estomac océanique, les estuaires sont des zones de transformation où les nutriments sont décomposés et recyclés, créant un écosystème dynamique de renouvellement et de régénération.",
    },
    position: {
      x: 42,
      y: 60,
  ...
  },
  {
    ...
    function: "Apporter de l'oxygène dans le corps et éliminer le dioxyde de carbone",
    ...
    oceanMetaphor: {
      ...
      marineSimilarity: "Tels des poumons océaniques, le phytoplancton agit comme un poumon global, produisant plus de 50% de l'oxygène terrestre et régulant l'échange gazeux à l'échelle planétaire.",
    },
    position: {
      x: 36,
      y: 30,
  ...
  },
  {
    id: "kidney",
    name: "Reins",
    description: "Organes de filtration qui régulent les fluides corporels et éliminent les déchets",
    function: "Filtrer le sang, réguler la pression artérielle, produire des hormones",
    ...
    oceanMetaphor: {
      ...
      marineSimilarity: "Comme des reins océaniques, les grands systèmes de courants marins comme le Gulf Stream agissent en tant que mécanismes de purification globaux, transportant et filtrant les nutriments et régulant la température planétaire.",
    },
    position: {
      x: 35,
      y: 75,
